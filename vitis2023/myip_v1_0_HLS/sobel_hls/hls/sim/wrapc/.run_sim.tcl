...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Program/Xilinx/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Program/Xilinx/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Program/Xilinx/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Program/Xilinx/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_hls.autotvin.dat"
	set constFileTvOut       "sobel_hls.autotvout.dat"
	set constFileHdlTvIn     "sobel_hls.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_hls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
