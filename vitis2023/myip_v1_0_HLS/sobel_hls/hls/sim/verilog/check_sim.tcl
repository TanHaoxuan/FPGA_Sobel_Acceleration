...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel_hls.autotvin_S_AXIS_V_data_V.dat"
         "c.sobel_hls.autotvin_S_AXIS_V_keep_V.dat"
         "c.sobel_hls.autotvin_S_AXIS_V_strb_V.dat"
         "c.sobel_hls.autotvin_S_AXIS_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel_hls.autotvout_M_AXIS_V_data_V.dat"
         "rtl.sobel_hls.autotvout_M_AXIS_V_keep_V.dat"
         "rtl.sobel_hls.autotvout_M_AXIS_V_strb_V.dat"
         "rtl.sobel_hls.autotvout_M_AXIS_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
