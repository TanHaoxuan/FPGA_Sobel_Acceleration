...
if {[file isfile sobel_hls.autotvin.dat]} {
	file delete -force sobel_hls.autotvin.dat
}

if {[file isfile sobel_hls.autotvout.dat]} {
	file delete -force sobel_hls.autotvout.dat
}
